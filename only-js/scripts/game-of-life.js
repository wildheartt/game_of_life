...
export class GameOfLife {
  ...
  sendWorkerInitFields({ random, rows, cols }) {
    this.load();
    this.disableInputs();
  ...
  initNodes(injectedNode) {
    ...
    const wrapperCanvasNode = this._querySelector(
      injectedNode,
      '.wrapper-canvas',
    );
    ...
    const popupPopulationNode = this._querySelector(
      popupNode,
      '.popup__population',
    );
    const popupCyclesNode = this._querySelector(popupNode, '.popup__cycles');
    const popupGenerateNode = this._querySelector(
      popupNode,
      '.popup__generate',
    );
    const popupRandomCheckboxNode = this._querySelector(
      popupNode,
      '.popup__random-checkbox',
    );
    const popupSpeedRangeNode = this._querySelector(
      popupNode,
      '.popup__speed-range',
    );
    const popupSpeedInfoNode = this._querySelector(
      popupNode,
      '.popup__speed-info',
    );
